...
namespace PRJ_QuanLyBanLaptop
{
    public partial class frmHoaDon : Form
    {
        ...
        bool kiem_tra_trung_ma_dh(TextBox t)
        {
            ketnoi();
            string sql = "select madh from don_hang where madh = @madh";
            cmd = new SqlCommand(sql, con);
        ...
        bool kiem_tra_trung_ma_dh2(TextBox t)
        {
            ketnoi();
            string sql = "select madh from chitiet_donhang where madh = @madh";
            cmd = new SqlCommand(sql, con);
            cmd.Parameters.AddWithValue("madh", txtMaHD.Text);
            SqlDataReader rdr = cmd.ExecuteReader();
            bool ma_trung = false;
        ...
        private void btThem_Click(object sender, EventArgs e)
        {
            ...
            else if (kiem_tra_trung_ma_dh(txtMaHD) == true || kiem_tra_trung_ma_dh2(txtMaHD) == true)
            {
